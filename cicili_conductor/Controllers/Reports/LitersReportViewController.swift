//
//  LitersReportViewController.swift
//  cicili_conductor
//
//  Created by ARIANA SANCHEZ on 26/02/20.
...
extension UITextField{
    ...
    func setLeftImageLR(imageName:String) {
...
extension UITextField {
    ...
    func setInputViewDatePickerLR(target: Any, selector: Selector) {
...
class LitersReportViewController: UIViewController {
    ...
    let appDelegate = UIApplication.shared.delegate as! AppDelegate
        ...
        override func viewDidLoad() {
            ...
            txtFechaInicio.setLeftImageLR(imageName: "icon_calendar")
             self.txtFechaInicio.setInputViewDatePickerLR(target: self, selector: #selector(tapDoneIni))
            txtFechaFinal.setLeftImageLR(imageName: "icon_calendar")
            self.txtFechaFinal.setInputViewDatePickerLR(target: self, selector: #selector(tapDoneFin))
